    ...
    const fetchAllowances = async () => {
      try {
        const response = await axios.get(
          `https://allowance-system-dfe7.onrender.com/api/application/userApplications/${user.docId}`
        );
        ...
        {toggle === 0 && (
          <>
            <div className="table-responsive">
              <div
                className="activate_deactivateCont"
                ...
                <table className="details-table">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{selectedEmployee.selectedAllowanceTypes
                    ...
                    <tr>
                      <th>Description</th>
                      <td>
                        {selectedEmployee.selectedAllowanceTypes
                          .map((allowance) => allowance.description)
